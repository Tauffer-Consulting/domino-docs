...
>
    ...
    <div>
        an intuitive <a href="/domino_components/domino_components_gui">Graphical User Interface</a> that facilitates creating, editing and monitoring any type of workflow, from data processing to machine learning
    </div>
</p>
...
>
    ...
    <div>
        a standard way of writing and publishing functional <a href="/pieces">Pieces</a>, which follows good practices for data modeling, documentation and distribution
    </div>
</p>
...
>
    ...
    <div>
        a <a href="/domino_components/domino_components_rest">REST API</a> that controls a running Apache Airflow instance, leveraging state-of-the-art workflow orchestration capabilities.
    </div>
</p>
...
- [Base Piece image](https://github.com/Tauffer-Consulting/domino/pkgs/container/domino-base-piece)
