...
>
    ...
    <div>
        an intuitive <a href="https://tauffer-consulting.github.io/domino-docs/docs/domino_components/domino_components_gui">Graphical User Interface</a> that facilitates creating, editing and monitoring any type of workflow, from data processing to machine learning
    </div>
</p>
...
>
    ...
    <div>
        a standard way of writing and publishing functional <a href="https://tauffer-consulting.github.io/domino-docs/docs/pieces">Pieces</a>, which follows good practices for data modeling, documentation and distribution
    </div>
</p>
...
>
    ...
    <div>
        a <a href="https://tauffer-consulting.github.io/domino-docs/docs/domino_components/domino_components_rest">REST API</a> that controls a running Apache Airflow instance, leveraging state-of-the-art workflow orchestration capabilities. 
    </div>
</p>
