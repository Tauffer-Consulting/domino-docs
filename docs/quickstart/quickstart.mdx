...
It is very simple to generate Github access tokens. See [Authorizing Domino to access Github repositories](/docs/usage/github_token) for a basic step-by-step.
  ...
  <TabItem value="workflowSettings" label="Workflow Settings">
    ...
    <ul>
      ...
      <li>
        ...
        For more information on shared storage, refer to the <a href='/docs/usage/shared_storage'> Shared storage section.</a>
      </li>
    </ul>
...
### What's Next?
Your Domino journey is just starting! Check the [Usage & Settings](/docs/usage) section to delve deeper into concepts such as Piece Repositories, Secrets, Local and Remote Shared Storage, and more!
