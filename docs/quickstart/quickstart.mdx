  ...
  <TabItem value="workflowSettings" label="Workflow Settings" default>
    ...
    <ul>
      ...
      <li>
        ...
        For more information on shared storage, refer to the section on <a href='/docs/run_domino/shared_storage'> shared storage </a>
      </li>
    </ul>
...
Dive into the [Advanced Workflows](/docs/quickstart/advanced_workflows) section to delve deeper into concepts such as Piece Repositories, Secrets, Local and Remote Shared Storage, and more!
